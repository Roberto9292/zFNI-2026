...
| **Búsqueda inteligente** | Por materia, carrera, bloque, docente o paralelo. Soporta múltiples términos a la vez y en cualquier orden (ej. `calculo bloque b perez`). Insensible a mayúsculas y acentos. Resultados paginados de 5 en 5 y marcados en el mapa. |
